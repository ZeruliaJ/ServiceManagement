(function () {
  ...
  if (!localStorage.getItem("dashticlayout")) {
    localStorage.setItem("dashticlayout", "horizontal");
  }
  if (!localStorage.getItem("dashticnavstyles")) {
    localStorage.setItem("dashticnavstyles", "menu-hover");
  }
  if (localStorage.getItem("dashticlayout") == "horizontal") {
    ...
    document
      .querySelector("html")
      .setAttribute("data-nav-style", "menu-hover");
  }
  ...
  function localStorageBackup() {
    ...
    if (localStorage.dashticdarktheme) {
      let html = document.querySelector("html");
      html.setAttribute("data-theme-mode", "dark");
    }
    if (localStorage.dashticlayout) {
      let html = document.querySelector("html");
      let layoutValue = localStorage.getItem("dashticlayout");
    ...
    if (localStorage.dashticverticalstyles) {
      let html = document.querySelector("html");
      let verticalStyles = localStorage.getItem("dashticverticalstyles");

      if (verticalStyles == "closed") {
        html.setAttribute("data-vertical-style", "closed");
        localStorage.removeItem("dashticnavstyles");
      }
        ...
        setTimeout(() => {
          ...
          menuSlideItem.forEach((e) => {
            ...
            e.addEventListener("mouseenter", () => {
              if (localStorage.dashticverticalstyles == "doublemenu") {
    ...
    if (localStorage.dashticnavstyles) {
      let html = document.querySelector("html");
      let navStyles = localStorage.getItem("dashticnavstyles");
      if (navStyles == "menu-click") {
        html.setAttribute("data-nav-style", "menu-hover");
        localStorage.removeItem("dashticverticalstyles");
    ...
    if (localStorage.dashticclassic) {
      let html = document.querySelector("html");
      html.setAttribute("data-page-style", "classic");
    }
    if (localStorage.dashticboxed) {
      let html = document.querySelector("html");
      html.setAttribute("data-width", "boxed");
    }
    if (localStorage.dashticheaderfixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "fixed");
    }
    if (localStorage.dashticheaderscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "scrollable");
    }
    if (localStorage.dashticmenufixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "fixed");
    }
    if (localStorage.dashticmenuscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "scrollable");
    }
    if (localStorage.dashticMenu) {
      let html = document.querySelector("html");
      let menuValue = localStorage.getItem("dashticMenu");
      switch (menuValue) {
        case "light":
    ...
    if (localStorage.dashticHeader) {
      let html = document.querySelector("html");
      let headerValue = localStorage.getItem("dashticHeader");
      switch (headerValue) {
        case "light":
