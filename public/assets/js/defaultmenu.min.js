...
(() => {
    ...
    if (
        !localStorage.getItem("dashticlayout") &&
        !localStorage.getItem("dashticnavstyles") &&
        !localStorage.getItem("dashticverticalstyles") &&
    ...
    function rtlFn() {
        ...
        //RTL
        if (localStorage.getItem('dashticrtl')) {
    ...
    if (html.getAttribute('data-nav-layout') === "horizontal" && !document.querySelector('.landing-body') == true) {
        setTimeout(() => {
            if (typeof horizontalClickFn === 'function') {
                horizontalClickFn();
            } else {
